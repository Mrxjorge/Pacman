...
{
	AWorldManager::GetWorldManager(this)->SubscribeCharacter(this);
	Super::BeginPlay();
}
...
void APacManCharacter::ControlPoints(int Value)
{
	Points += Value;
...
{
	// If PacMan is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in PacMan.Build.cs is not automatically propagated
